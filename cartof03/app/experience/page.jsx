...
export default function Experience() {
  return (
    <main className='text-zinc-600'>
      <header className='xl:mt-48 xl:text-xl xs:flex-col xs:place-content-center sm:mt-28 sm:space-y-14'>
        <p className='text-zinc-400 xl:mx-96 xl:text-2xl sm:text-lg sm:leading-7 sm:text-center sm:mx-48'>&lt; Get to know me better and explore my journey as a <span className='text-white font-bold'>Front-End Software Engineer</span> /&gt;</p>
      ...
      <section className='bg-zinc-900 rounded-2xl xl:text-2xl xl:flex xl:flex-row sm:flex-col sm:space-y-14 sm:mt-28 sm:mx-14 sm:leading-7 sm:py-14 sm:px-7'>
        <div className='xl:min-w-96 xl:mt-14 xl:flex-col'>
          <h2 className='text-white font-bold'>Front end Sowftare engineer</h2>
          <span className='text-violet-400 sm:my-96'>Contact</span>
          <p>time</p>
          <p>location</p>
        </div>
        <div className='xl:min-w-96 xl:flex-col sm:leading-10'>
